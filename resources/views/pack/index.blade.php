    ...
    <div class="card card-info">
      <div class="card-header">
         <span class="float-right">
            <button type="button" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Registrar Pack" data-toggle="modal" data-target="#crear">
              <i class="fas fa-plus-square"></i>
            </button>
          </span>
        <h3 class="card-title">Lista de Packs</h3>
      </div>
      <div class="card-body">
                ...
                @foreach($data as $u)
                  <tr>
                    <td class="text-center">
                      <a href="{{ route('pack.edit',$u->id) }}">{{ $u->name }}</a>
                    </td>
                  </tr>
                @endforeach
            </tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content card-danger">
      <div class="modal-header" style="background-color: #17a2b8 ">
        <h5 class="modal-title" id="exampleModalLabel">Crear Pack</h5>
