@extends('layouts.app')
@section('titulo','Pack - '.config('app.name'))
@section('header','Pack')

@section('breadcrumb')
<ol class="breadcrumb float-sm-right">
  <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
  <li class="breadcrumb-item active">Editar Pack</li>
</ol>
@endsection
@section('content')
<div class="row">
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">Editar Pack</h3>
      </div>
      <div class="card-body">
          <form action="{{ route('pack.update',$dato->id) }}" method="POST">
              @csrf
              @method('PUT')
              <div class="row">
